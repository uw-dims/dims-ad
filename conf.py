# -*- coding: utf-8 -*-
#
# DIMS Architecture Design documentation build configuration file, created by
...
htmlhelp_basename = 'DIMSArchitectureDesigndoc'
...
texinfo_documents = [
  ('index', 'DIMSArchitectureDesign', u'DIMS Architecture Design Documentation',
   u'David Dittrich', 'DIMSArchitectureDesign', 'One line description of project.',
   'Miscellaneous'),
]
